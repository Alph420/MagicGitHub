...
public class UserListInstrumentedTest {
    ...
    public void checkIfRecyclerViewIsNotEmpty() {
        // Verifie le nombre visuel d'user comparer au nombre d'user dans la liste
    ...
    public void checkIfAddingRandomUserIsWorking() {
        //Ajoute un user puis verifier si il y'a bien un user supplementaire dans la liste
    ...
    public void checkIfRemovingUserIsWorking() {
        //Supprime une user puis verifier si il y'a bien un utilisateur en moins dans la liste
